...
module.exports = exports = function (proto) {
  function compare(orig, compareTo, options, cb) {
    ...
    var args = ['-metric', 'mse', orig, compareTo] // mean squre error - mittlere quadratische abweichung
    //var args = ['-metric', 'mae', orig, compareTo] //mean absoulte Error
    //var args = ['-metric', 'pae', orig, compareTo] //peak absoulte error
    //var args = ['-metric', 'psnr', orig, compareTo] // peak signal to noise ratio // he höher desto änhlicher
    //var args = ['-metric', 'rmse', orig, compareTo] // root mean squared error

    if (typeof options === 'object') {
      if(options.metric){
        args[1] = options.metric;
      }
    }
